		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Projeto Log01",
									"targetURL": "#projectlog01-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"projectlog01-display": {
								"semanticObject": "projectlog01",
								"action": "display",
								"description": "A Fiori application - projectlog01",
								"title": "Projeto Log01",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=projectlog01",
									"url": sap.ui.require.toUrl("projectlog01")
								}
							}
						}
					}
